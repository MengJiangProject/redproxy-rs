// src/listeners/http_forward_tests.rs
...
// HttpListenerConfigStruct alias is removed as we construct Value directly
...
async fn setup_proxy_server(
    ...
    // Create config as serde_yaml_ng::Value since HttpListener fields are private
...
"#,
    ...
    ); // Ensure SocketAddr is Display for format!
